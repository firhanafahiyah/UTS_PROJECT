...
<body class="main-layout">
   ...
   <div id="myNav" class="menu_sid">
      ...
      <div class="menu_sid-content">
         <a href="#protien">Produk Kami</a>
         <a href="#about">Tentang Kami</a>
         <a href="#testimonial">Testimonial</a>
         <a href="#contact">Contact Us</a>
         <a href="admin/index.php">Admin</a>
         <a href="pengunjung/index.php">Tamu</a>
      </div>
   </div>
   <!-- header -->
   <header>
                  ...
                  <div class="row">
                     <div class="col-md-5">
                        <div class="banner_text">
                           <h1>Protien Pembangun Tubuh Pro</h1>
            ...
            <?php foreach ($produks as $row) : ?>
               <div class="col-md-3 col-sm-6">
                  <div class="protien">
                     ...
                     <a class="read_more mar_top" href="detail.php?id=<?= $row['id'] ?>"> Detail Produk</a>
                  </div>
               </div>
            <?php endforeach; ?>
         </div>
   ...
   <div class="growyhing">
      <div class="container">
         <div class="row d_flex">
            ...
            <div class="col-md-6">
               <div class="titlepage">
                  <h2>Tumbuh Tubuh Anda Dari Protien</h2>
                  <a class="read_more" href="Javascript:void(0)"> Read More</a>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption relative2">
                                 <div class="row d_flex">
                                    <div class="col-md-11">
                                       ...
                                       <span>Chrish John</span>
                                       <p>"Suplemen olahraga ini benar-benar mengubah hidup saya. Saya
                                          merasa lebih kuat dan lebih sehat dari sebelumnya. Ini adalah
                                          alat yang luar biasa untuk meningkatkan performa saya di
                                          lapangan dan membantu saya untuk mencapai tujuan olahraga saya!"
                                       </p>
                                    </div>
                                 </div>
                              </div>
